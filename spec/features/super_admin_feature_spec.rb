...
describe 'super admin user', type: :feature do
	...
	before do
		@user = create(:user, first_name: 'joe', email: 'abc@example.com', password: 'asdf', password_confirmation: 'asdf', role:'super_admin')
    visit '/'
	...
	it 'has a role of super admin' do
		visit '/'
...
describe 'super admin dashboard' do
  ...
  xit "can see all existing users" do
    visit "/super_admin/users"
